#Yao, Ni, et al. "Deep learning-based diagnosis of disease activity in patients with Graves’ orbitopathy using orbital SPECT/CT." European journal of nuclear medicine and molecular imaging (2023): 1-9.
import torch
